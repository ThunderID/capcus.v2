			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<ul>
						...
						<li><a href="{{ route('web.blog') }}">Tujuan Wisata</a></li>
						<li><span>{{ $place->long_name }}</span></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-9">
					<div class="blog-page__content blog-single">
						...
						<div class="post">
							<div class="post-meta">
								<div class="date">{{ $place->destination->long_name}}</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center mb-lg mt-xs">
									<img src="{{ $place->images->where('name', 'SmallImage')->first()->path }}" alt="{{ $place->title }}"  style='width:100%'>
								</div>
							</div>
							<div class="post-body">
