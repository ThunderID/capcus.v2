		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-push-3 text-black">
					<h3 class='mb-lg mt-xxxl text-uppercase'>Term and Conditions</h3>

					<div class="panel panel-default">
						<div class="panel-body pt-lg pb-lg">
							<div class='ml-sm mr-sm'>
							<p>Website usage terms and conditions
							<p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern capcus’s relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.
								The term ‘capcus’ or ‘us’ or ‘we’ refers to the owner of the website whose registered office is The CEO Building Lv 12, Jl. TB Simatupang No. 18C 
								Jakarta Selatan 12430, Indonesia. The term ‘you’ refers to the user or viewer of our website.
