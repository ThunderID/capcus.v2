			...
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
				...
				<div class='mb-md'>
					...
					<h1 class='text-uppercase mb-lg'>
						Berlangganan Newsletter Capcus
					</h1>

					<p>Maaf, terjadi kesalahan pengisian email yang akan digunakan untuk berlangganan newsletter Capcus. Silahkan isikan kembali email anda pada form berikut:</p>


					@include('web.widgets.subscribe.form'			, [])
