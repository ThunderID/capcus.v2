	...
	<div class='mb-sm'>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
				@if ($data->images && $data->images->where('name', $field_name)->first()->path)
					<img src='{{$data->images->where('name', $field_name)->first()->path}}' class='thumbnail img-responsive'>
				@else
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
				...
				@endif
				{!! Form::text($field_name, ($data->images ? $data->images->where('name', $field_name)->first()->path : ''), [
				...
				<br>
				{!! Form::textarea($field_name.'_description', ($data->images ? $data->images->where('name', $field_name)->first()->description : ''), [
														'class' 			=> 'form-control', 
