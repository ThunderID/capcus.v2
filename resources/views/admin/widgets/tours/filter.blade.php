<?php
	...
	// REQUIRED VARIABLES
	// ------------------------------------------------------------------------------------------------------------------------
	$required_variables = ['filter_name', 'filter_travel_agent', 'travel_agents'];
	...
	@section('widget_body')
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-xs">
				<small>Search</small>
				{!! Form::text('filter_tour_name', $filter_name, ['class' => 'form-control', 'placeholder' => 'Search...']) !!}
			</div>

			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-xs">
				<small>By Travel Agent</small>
				{!! Form::select('filter_tour_travel_agent', $travel_agents->lists('name', 'id'), $filter_travel_agent, ['class' => 'form-control select2', 'placeholder' => 'Semua']) !!}
			</div>
